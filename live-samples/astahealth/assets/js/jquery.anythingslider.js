...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.init = function(){
			...
			base.adj = (o.infiniteSlides) ? 1 : 0; // adjust page limits for infinite or limited modes
		...
		base.buildNextBackButtons = function() {
			base.$forward = $('<span class="arrow forward"><a href="#"><span style="font-size: 25pt; opacity: .7; border-radius: 8px; padding: 5px; color:#0B617F; margin-top: 40px; margin-left: 20px; width: 100px; background: #fff">' + o.forwardText + '</span></a></span>');
			base.$back = $('<span class="arrow back"><a href="#"><span style="font-size: 25pt; opacity: .7; border-radius: 8px; padding: 5px; color:#0B617F; margin-top: 40px; margin-left: -80px; width: 100px; background: #fff">' + o.backText + '</span></a></span>');
		...
		base.gotoPage = function(page, autoplay, callback, time) {
			...
			base.exactPage = page;
			if (page > base.pages + 1 - base.adj) { page = (!o.infiniteSlides && !o.stopAtEnd) ? 0 : base.pages; }
...
*/
		...
		forwardText         : "Next&nbsp&raquo;", // Link text used to move the slider forward (hidden by CSS, replaced with arrow image)
		backText            : "&laquo;&nbspBack", // Link text used to move the slider back (hidden by CSS, replace with arrow image)
